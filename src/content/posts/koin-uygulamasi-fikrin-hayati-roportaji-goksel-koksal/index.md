...
meta_title: "Döviz kuru çevirici uygulaması."
...
Tasarım için [Sketch](https://www.sketch.com/).

Geliştirme içinse tabi ki [Xcode](https://developer.apple.com/xcode/) ve [Swift](https://developer.apple.com/swift/).
